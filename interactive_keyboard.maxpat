...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 45.0, 425.0, 64.0 ],
					"style" : "",
					"text" : "To play the sound, click \"startwindow\".\nType on keyboard to make sound! (see below for key-note mapping)\nCurrently supports one octave\n(inspired by UC Berkeley Music 158A)",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 811.0, 545.0, 150.0, 75.0 ],
					"text" : "/keys/all : \"delete\",\n/numKeysDown : 1,\n/key : \"delete\"",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 869.0, 373.0, 150.0, 75.0 ],
					"text" : "/keys/all : \"delete\",\n/numKeysDown : 1,\n/key : \"delete\"",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 793.0, 235.0, 266.0, 100.0 ],
					"text" : "map(\n  lambda(i,\n    assign(/key, /keys/all[[i]])\n\t  ),\n  aseq(0, /numKeysDown - 1)\n)",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 183.0, 150.0, 61.0 ],
					"text" : "/keys/all : \"delete\",\n/numKeysDown : 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 364.0, 167.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 874.0, 115.0, 150.0, 34.0 ],
					"text" : "/numKeysDown : 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 419.922485, 897.5, 32.5, 32.5 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 365.5, 985.5, 71.0, 23.0 ],
					"sig" : 0.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.5, 897.5, 40.0, 22.0 ],
					"style" : "",
					"text" : "open",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 365.5, 950.5, 71.0, 22.0 ],
					"style" : "",
					"text" : "sfrecord~ 1",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 556.0, 592.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 556.0, 534.0, 150.0, 34.0 ],
									"text" : "/numKeysDown : 1",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 76.0, 633.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 193.0, 211.0, 62.0, 22.0 ],
									"style" : "",
									"text" : "t b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 438.0, 132.0, 335.0, 170.0 ],
									"text" : "/ascii : \"delete\",\n/keystate : \"up\",\n/keynum : -7,\n/numKeysDown : 0,\n/fingerIndex : 1,\n/shift : \"up\",\n/capslock : \"up\",\n/option : \"up\",\n/control : \"up\",\n/command : \"up\",\n/time : 2017-09-12T06:16:09.303845Z",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "FullPacket" ],
									"patching_rect" : [ 76.0, 535.0, 186.0, 22.0 ],
									"style" : "",
									"text" : "o.select /keys/all /numKeysDown"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "FullPacket", "FullPacket" ],
									"patching_rect" : [ 76.0, 136.5, 136.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 236.0, 256.0, 37.0, 22.0 ],
									"style" : "",
									"text" : "clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 76.0, 573.5, 351.0, 34.0 ],
									"text" : "/keys/all : \"delete\"",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 76.0, 315.5, 179.0, 22.0 ],
									"style" : "",
									"text" : "o.union"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 102.0, 473.5, 100.0, 22.0 ],
									"style" : "",
									"text" : "o.prepend /prev"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "FullPacket" ],
									"patching_rect" : [ 102.0, 439.5, 99.0, 22.0 ],
									"style" : "",
									"text" : "o.select /keys/all"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "FullPacket", "FullPacket" ],
									"patching_rect" : [ 76.0, 349.5, 315.0, 73.0 ],
									"text" : "if( bound( /prev/keys/all ),\n  /keys/all = [ /prev/keys/all, /ascii ],\n    /keys/all = /ascii\n)",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "FullPacket" ],
									"patching_rect" : [ 42.0, 256.0, 170.0, 22.0 ],
									"style" : "",
									"text" : "o.select /ascii /numKeysDown"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 76.0, 100.0, 116.0, 22.0 ],
									"style" : "",
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-36", 1 ],
									"midpoints" : [ 111.5, 505.5, 405.0, 505.5, 405.0, 307.5, 245.5, 307.5 ],
									"source" : [ "obj-56", 0 ]
								}
...
,
					"patching_rect" : [ 364.0, 121.0, 160.0, 22.0 ],
...
,
					"style" : "",
					"text" : "p accumulate keys pressed"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 355.5, 577.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "o.route /note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.5, 619.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "60"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 121.511841, 758.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 355.5, 688.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "mtof"
				}
...
,
					"patching_rect" : [ 355.5, 729.0, 60.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 355.5, 785.0, 45.0, 22.0 ],
					"style" : "",
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 869.0, 151.0, 252.0, 34.0 ],
					"text" : "/keys/all : \"delete\"",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 281.5, 905.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 169.5, 905.0, 76.0, 22.0 ],
					"style" : "",
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 374.0, 284.0, 330.0, 249.0 ],
					"text" : "\nprogn(\n    if( /key == \"a\", /note = 60 ),\n    if( /key == \"w\", /note = 61 ),\n    if( /key == \"s\", /note = 62 ),\n\t\t    if( /key == \"e\", /note = 63 ),\n    if( /key == \"d\", /note = 64 ),\n    if( /key == \"f\", /note = 65 ),\n    if( /key == \"t\", /note = 66 ),\n    if( /key == \"g\", /note = 67 ),\n    if( /key == \"y\", /note = 68 ),\n    if( /key == \"h\", /note = 69 ),\n    if( /key == \"u\", /note = 70 ),\n    if( /key == \"j\", /note = 71 ),\n    if( /key == \"k\", /note = 72)\n)\n",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 355.5, 623.0, 336.0, 53.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 74.511841, 933.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 12.0, 331.0, 26.0 ],
					"style" : "",
					"text" : "Random Instrument: Interactive Keyboard"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 429.422485, 936.0, 377.511841, 936.0, 377.511841, 938.0, 375.0, 938.0 ],
					"source" : [ "obj-169", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 514.5, 153.0, 642.5, 153.0, 642.5, 114.0, 883.5, 114.0 ],
					"order" : 0,
					"source" : [ "obj-70", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 514.5, 154.5, 404.5, 154.5 ],
					"order" : 1,
					"source" : [ "obj-70", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 373.5, 156.25, 878.5, 156.25 ],
					"order" : 0,
					"source" : [ "obj-70", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 179.0, 927.5, 84.011841, 927.5 ],
					"source" : [ "obj-81", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 291.0, 927.5, 84.011841, 927.5 ],
					"source" : [ "obj-85", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-172", 0 ],
					"midpoints" : [ 131.011841, 929.75, 375.0, 929.75 ],
					"order" : 0,
					"source" : [ "obj-94", 0 ]
				}
